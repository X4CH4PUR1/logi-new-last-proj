...
import { DEFAULT_LANGUAGE, LANGUAGE_CODES, LANGUAGES, STORAGE } from '../data/config.js';
import * as storage from '../util/storage.js';
import * as store from './store.js';
import { pick } from '../util/format.js';
...
export function base(key, lang = current) {
...
export function localise(value) {
