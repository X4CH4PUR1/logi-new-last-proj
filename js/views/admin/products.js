...
import { allProducts } from '../../core/selectors.js';
import { CATEGORIES, CONDITIONS, FUELS, MODES } from '../../data/config.js';
import { formatPrice, makeId, pick } from '../../util/format.js';
import {
  commit,
  confirmThen,
  editorActions,
