 ...
 */
export function editLangSwitch(onChange) {
...
export function patchDebounced(mutator, delay = 350) {
 ...
 */
export function commit(mutator, message) {
  window.clearTimeout(saveTimer);
 ...
 */
export function textArea({ label, value, onInput, rows = 3, hint }) {
 ...
 */
export function select({ label, value, options, onInput, hint }) {
  const el = h(
 ...
 */
export function localisedInput({ label, value, onInput, multiline = false, rows = 3, hint }) {
...
export function setTranslation(object, key, lang, value) {
...
export function editorPanel(title, ...children) {
  return h('div.admin-editor', {}, h('h3.admin-editor__title', { text: title }), ...children);
}

export function editorGrid(...children) {
  return h('div.admin-editor__grid', {}, ...children);
}

export function editorActions(...children) {
